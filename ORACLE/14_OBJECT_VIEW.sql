...
-- INSERT
INSERT INTO VM_JOINEMP VALUES(300, '조세오', '총무부');
INSERT INTO VM_JOINEMP(EMP_ID, EMP_NAME) VALUES(500, '조세오');
...
--200번 사원의 급여를 200만원으로 변경 (VM_EMP 사용해서)
UPDATE VM_EMP
SET SALARY = 2000000
WHERE EMP_ID = 200; 
...
UPDATE VM_EMP
SET SALARY = 4000000
WHERE EMP_ID = 200; --> 서브쿼리에 기술한 조건이 부합되기 때문에 변경 가능
...
-- INSERT
INSERT INTO VM_DEPT VALUES('D0', '해외영업 4부', 'L5');
...
-- DELETE
DELTE FROM VM_DEPT WHERE DEPT_TITLE = '해외영업2부';
