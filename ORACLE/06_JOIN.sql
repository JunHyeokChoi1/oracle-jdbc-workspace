...
LEFT JOIN LOCATION L ON (D.LOCAION_ID = L.LOCAL_CODE) WHERE BONUS IS NOT NULL;
--오라클 구문
SELECT EMP_NAME, BONUS, SALARY*12, DEPT_TITLE, LOCAL_NAME 
FROM EMPLOTEE E, DEPARTMENT D, 
LOCATION L. WHERE E.DEPT_CODE = D.DEPT_ID AND D.LOCATION_ID = L.LOCAL_CODE AND BONUS IS NOT NULL;
...
WHEN SAL_LEVEL IN ('S5', 'S6') THEN '초급'
END "구분"
FROM EMPLOYEE E, JOB J, SAL_GREADE S
WHERE E.JOB_CODE = J.JOB_CODE
AND E.SALARY BETWEEN S.MIN_SAL AND S.MAX_SAL;
