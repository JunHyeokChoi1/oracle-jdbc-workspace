...
public class Member {
	...
	public Member(String memberId, String memberPassword, String memberNickname, String memberEmail, String memberPhone,
		...
		this.memberAuthoruty = memberAuthoruty;
	}
	...
	public String getMemberAuthoruty() {
		return memberAuthoruty;
	}
	public void setMemberAuthoruty(String memberAuthoruty) {
		this.memberAuthoruty = memberAuthoruty;
	}
	@Override
	public String toString() {
		return "Member [memberId=" + memberId + ", memberPassword=" + memberPassword + ", memberNickname="
				...
				+ memberGender + ", memberAuthoruty=" + memberAuthoruty + "]";
	}
